...
ImageWatcher.prototype.setup = function (config) {
    ...
    function updateImage(fileName) {
        ...
        function updateDone() {
            ...
            if (filter(self.images, function (image) { return image.checksum === oldImageData.checksum;}).length === 0) {
    ...
    function deleteImage(fileName) {
        ...
        if (filter(self.images, function (image) { return image.checksum === self.images[filePath].checksum;}).length < 2) {
